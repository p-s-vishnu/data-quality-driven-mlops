...
from classification.experiments import LogRegExperiment
"""
...
pollution_methods = [FeatureAccuracyPolluter]
# list of experiment classes for clustering
experiments = [LogRegExperiment]
