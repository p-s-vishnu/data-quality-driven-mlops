...
from .tabular import TabularFileConfig, TabularFileReader
...
def data_factory(reader_config: ReaderConfig) -> DataWithInfo:
    ...
    elif isinstance(reader_config, TabularFileConfig):
        return TabularFileReader.read_data(reader_config)
    else:
