...
@dataclass
class TabularEmbeddingModelSpec:
    # A dictionary mapping column names to the number of dimensions for the embedding
    # TODO: https://pytorch-tabular.readthedocs.io/en/latest/models/
    # TODO: https://arxiv.org/abs/2203.05556
